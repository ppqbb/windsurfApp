...
from accounts.serializers import UserSerializer, CompanyProfileSerializer
...
class JobSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'company', 'title', 'description', 'requirements',
                 ...
                 'deadline', 'custom_questions', 'is_remote', 'salary_min',
                 'salary_max', 'skills_required', 'responsibilities')
...
class JobListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'title', 'company_name', 'category_name', 'location',
                 'employment_type', 'experience_level', 'created_at', 'deadline',  
